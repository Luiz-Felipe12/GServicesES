...
class AdministradorsTest < ApplicationSystemTestCase
  ...
  test "should create administrador" do
    ...
    fill_in "Data de nascimento", with: @administrador.data_de_nascimento
    fill_in "Email", with: @administrador.email
    fill_in "Nome completo", with: @administrador.nome_completo
    fill_in "Senha", with: @administrador.senha
    fill_in "Telefone", with: @administrador.telefone
