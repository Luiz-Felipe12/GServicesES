...
class TrabalhadorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trabalhador" do
    assert_difference("Trabalhador.count") do
      post trabalhadors_url, params: { trabalhador: { data_de_nascimento: @trabalhador.data_de_nascimento, email: @trabalhador.email, nome_completo: @trabalhador.nome_completo, profissao: @trabalhador.profissao, senha: @trabalhador.senha, telefone: @trabalhador.telefone } }
    end
  ...
  test "should update trabalhador" do
    patch trabalhador_url(@trabalhador), params: { trabalhador: { data_de_nascimento: @trabalhador.data_de_nascimento, email: @trabalhador.email, nome_completo: @trabalhador.nome_completo, profissao: @trabalhador.profissao, senha: @trabalhador.senha, telefone: @trabalhador.telefone } }
