...
class AdministradorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrador" do
    assert_difference("Administrador.count") do
      post administradors_url, params: { administrador: { data_de_nascimento: @administrador.data_de_nascimento, email: @administrador.email, nome_completo: @administrador.nome_completo, senha: @administrador.senha, telefone: @administrador.telefone } }
    end
  ...
  test "should update administrador" do
    patch administrador_url(@administrador), params: { administrador: { data_de_nascimento: @administrador.data_de_nascimento, email: @administrador.email, nome_completo: @administrador.nome_completo, senha: @administrador.senha, telefone: @administrador.telefone } }
